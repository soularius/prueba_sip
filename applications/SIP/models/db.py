...
Student(db).define_table()
DayOfWeek(db).define_table()
Salons(db).define_table()
Schedules(db).define_table()
Subjects(db).define_table()
Teachers(db).define_table()
Classes(db).define_table()
ClassesStudents(db).define_table()
Attendance(db).define_table()